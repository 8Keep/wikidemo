...
showing/displaying player stats, etc

The Indicator uses the 3 standard constructors as shown in the [Quick
Start Guide](../../../jme3/contributions/tonegodgui/quickstart) with
...
-   Clipping + an alpha mask to create any shaped indicator you would
    like
...
Cut & Paste the following code into the simpleInitApp method of a new
JME project. Use the slider to adjust the indicator.
...
![indicatorexample.png](/images/../jme3/contributions/tonegodgui/indicatorexample.png)
