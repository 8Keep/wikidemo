Parent: [jMonkeyEngine 3 Tutorial (5) - Hello Input
System](../../../jme3/beginner/hello_input_system)

Here is a sample of a program where the camera accelerates if the key is
kept pressed.
