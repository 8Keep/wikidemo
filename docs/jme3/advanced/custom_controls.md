A `com.jme3.scene.control.Control` is a customizable jME3 interface that
...
-   One Spatial can be influenced by several Controls. (Very powerful
    and modular!)
...
-   `cloneForSpatial(Spatial)`: Clones the Control and attaches it to a
