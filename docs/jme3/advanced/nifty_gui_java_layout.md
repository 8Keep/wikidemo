...
The following minimal Java file contains a start screen and a HUD
...
Try the sample. Remember to activate a screen using
...
Note that the width and height do not scale the bitmap font, but make
