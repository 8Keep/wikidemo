By assets we mean multi-media files, such as 3D models, materials,
...
This Material is "somewhere" in the jME3 JAR; the default Asset Manager
...
My game runs fine when I run it right from the jMonkeyEngine SDK. But
