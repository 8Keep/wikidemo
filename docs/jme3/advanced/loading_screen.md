...
This example will use the existing hello terrain as an example. It will
require these 2 images inside Assets/Interface/ (save them as border.png
and inner.png respectively).

![inner1.png](/images/jme3/advanced/inner1.png)

![border1.png](/images/jme3/advanced/border1.png)

You need to add the jme3-niftygui and
[jme3-test-data](../../sdk/sample_code.xml#jme3testdata-assets#)
libraries.
...
![loadingscreen.png](/images/jme3/advanced/loadingscreen.png)
...
The progress bar and text is done statically using nifty XML. A custom
control is created, which represents the progress bar.
...
This screen simply displays a button in the middle of the screen, which
could be seen as a simple main menu UI.
...
This screen displays our custom progress bar control with a text
control.
...
There are 3 main ways to update a progress bar. To understand why these
...
progressbar on the screen would not have visibly changed.
...
For more info on multithreading: [The jME3 Threading
Model](../../jme3/advanced/multithreading)

Make sure to change the XML file to point the controller to
TestLoadingScreen\*1\*.
